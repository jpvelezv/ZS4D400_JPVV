CLASS zcl_jpvv_22_select_conversion DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_jpvv_22_select_conversion IMPLEMENTATION.
...
*              WHERE customer_id = '000004' AND currency_code <> 'EUR'
               INTO TABLE @DATA(result_currency).
      CATCH cx_sy_open_sql_db .
        out->write( 'Error al convertir' ).
    ENDTRY.
