CLASS zcl_fill_zs4djpvv_flights DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
*Add 50 new connection numbers and 2000 days of flights for each
    ...
    INSERT ZS4DJPVV_flights FROM TABLE @insert_tab.
    out->write( |Generated { sy-dbcnt } rows in table ZS4DJPVV_flights| ).
  ENDMETHOD.
ENDCLASS.
