CLASS zcl_generate_travel_data_jpvv DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ZCL_GENERATE_TRAVEL_DATA_JPVV IMPLEMENTATION.


  METHOD if_oo_adt_classrun~main.
    DATA itab TYPE TABLE OF ztravel_jpvv.
...
*   insert the new table entries
    INSERT ztravel_jpvv FROM TABLE @itab.
