...
CLASS lhc_travel DEFINITION INHERITING FROM cl_abap_behavior_handler.
  ...
  PRIVATE SECTION.
    ...
    TYPES tt_travel_update TYPE TABLE FOR UPDATE zi_travel_m_jpvv.
...
********************************************************************************
  METHOD get_features.
    ...
    READ ENTITY zi_travel_m_jpvv FROM VALUE #( FOR keyval IN keys
                                                      (  %key                    = keyval-%key
  ...
  METHOD validate_agency.
    ...
    READ ENTITY zi_travel_m_jpvv\\travel FROM VALUE #(
  ...
  METHOD calculatetravelkey.
    READ ENTITIES OF zi_travel_m_jpvv IN LOCAL MODE
        ENTITY Travel
          FIELDS ( travel_id )
    ...
    "Get max travelID
    SELECT SINGLE FROM ztravel_jpvv FIELDS MAX( travel_id ) INTO @DATA(lv_max_travelid).

    "update involved instances
    MODIFY ENTITIES OF zi_travel_m_jpvv IN LOCAL MODE
      ENTITY Travel
